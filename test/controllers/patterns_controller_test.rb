...
class PatternsControllerTest < ActionController::TestCase
  ...
  test "should create pattern" do
    assert_difference('Pattern.count') do
      post :create, pattern: { canonical: @pattern.canonical, citation_id: @pattern.citation_id, commentary: @pattern.commentary, name: @pattern.name, pulse: @pattern.pulse, slug: @pattern.slug, tongue: @pattern.tongue }
    end
  ...
  test "should update pattern" do
    patch :update, id: @pattern, pattern: { canonical: @pattern.canonical, citation_id: @pattern.citation_id, commentary: @pattern.commentary, name: @pattern.name, pulse: @pattern.pulse, slug: @pattern.slug, tongue: @pattern.tongue }
    assert_redirected_to pattern_path(assigns(:pattern))
  end
