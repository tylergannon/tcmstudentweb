  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved pattern as @pattern" do
        ...
        allow_any_instance_of(Pattern).to receive(:save).and_return(false)
        post :create, {:pattern => { "name" => "invalid value" }}, valid_session
        expect(assigns(:pattern)).to be_a_new(Pattern)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested pattern" do
        ...
        expect_any_instance_of(Pattern).to receive(:update).with({ "name" => "MyString" })
        put :update, {:id => pattern.to_param, :pattern => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the pattern as @pattern" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Pattern).to receive(:save).and_return(false)
        put :update, {:id => pattern.to_param, :pattern => { "name" => "invalid value" }}, valid_session
        expect(assigns(:pattern)).to eq(pattern)
      end
